    ...
    return (
        <div className="App slide-in">
            ...
            <div className="portion">
                ...
                <p className="para3">MUN is not an organization, like the UN. It first surfaced as a student-run Model League of Nations in the 1920s, 
                    since the League of Nations was the predecessor of the UN and when the UN was formed, the MUN era exploded. 
