...
function Welcome() {
    return (
        <div id = "app" className="App">
            <div id="letter" className="slide-in">
                <h6>Dear current and future delegates,</h6>
                <br></br>
                <p>Welcome to EHSMUN! By joining MUN, I am sure that you will be able to not only improve your public 
                    ...
                    <br></br><br></br>
                    I do warn you, however, that there will be an overwhelming amount of challenges: you are too scared to speak, the committee you are in 
